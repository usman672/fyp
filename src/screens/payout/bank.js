...
class sellItem extends Component {
  ...
  onSelectItem = (index, type) => {
    console.log(this.state.pickerColors[index].name, 'efergft45g  ', index);
    this.setState({
      selectedColorIndex: index,
      color: this.state.pickerColors[index].name,
    });
  };
            ...
            <View style={styles.inputView}>
              <View style={styles.inputViewInternal}>
                <TextInput
                  ...
                  onChangeText={(desc1) => this.onChangeDescription1(desc1)}
                />
                <CustomSeparator
                  heightt={1}
